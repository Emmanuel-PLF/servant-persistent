...
makePool Test env =
  runKatipT env (createMongoDBPool "servantTest" "localhost" (PortNumber 27017) Nothing (envPool Test) 5 2000)
makePool Development env =
  runKatipT env $ createMongoDBPool "servantTest" "localhost" (PortNumber 27017) Nothing (envPool Development) 5 2000
makePool Production env = do
  ...
  pool <- runMaybeT $ do
    ...
    lift $ runKatipT env $ createMongoDBPool "servantMong" "localhost" (PortNumber 27017) Nothing (envPool Production) 5 2000
  case pool of
